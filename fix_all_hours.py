#!/usr/bin/env python3
"""
Script pour corriger toutes les heures d'ouverture incomplètes.
"""
...
def fix_hours(filepath):
    try:
        ...
        # Pattern pour les heures incomplètes (plusieurs variantes)
        patterns = [
            r'<ul class="opening-hours-list">\s*<li><span class="opening-hours-day">Maandag</span><span class="opening-hours-time[^"]*">[^<]+</span></li>\s*</ul>',
            r'<ul class="opening-hours-list">\s*<li>[^<]*</li>\s*</ul>',
        ]
